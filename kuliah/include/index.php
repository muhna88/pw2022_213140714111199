    ...
    <section id="product-item" >
        <div class="container">
           ...
           <?php 
            ...
            `p`.`id_penerbit` ORDER BY `b`.`id_buku` DESC LIMIT 7";
            //echo $sql_b;
              ...
              <section id="quotes-item" class="bg-light" style="min-height: 80px;padding:40px 0px 0px 0px;">
                  <div class="container">
                      <blockquote class="blockquote text-center">
                          <p class="mb-0">Don't forget, beautiful sunsets needs cloudy skies.</p>
                          <footer class="blockquote-footer">Paulo Coelho</footer>
                      </blockquote>
                  </div>
              </section><br><br>