              ...
              <table class="table table-bordered">
                    ...
                    <tr>
                      ...
                      <td align="center">
                        ...
                        <a href="javascript:if(confirm('Anda yakin ingin menghapus blog <?php echo $judul; ?>?'))window.location.href='index.php?include=blog&aksi=hapus&data=<?php echo $id_blog;?>&notif=hapusblogberhasil'" 
