                    ...
                    if(!isset($_GET['halaman'])){
                      ...
                      ?>
                        <tr>
                          ...
                          fa-eye"></i>Detail</a>
                          <a href="javascript:if(confirm('Anda yakin ingin menghapus buku <?php echo $judul; ?>?')) window.location.href=
                          'index.php?include=buku&aksi=hapus&data=<?php echo $id_buku;?>&notif=hapusberhasil'"
              ...
              if($jum_halaman==0){
                //tidak ada halaman
                  ...
                  if (isset($_POST["katakunci"])){
                      ...
                      if($halaman!=1){
                        echo "<li class='page-item'><a class='page-link' href='index.php?include=buku&katakunci=$kata_kunci&halaman=1'>First</a></li>";
                        echo "<li class='page-item'><a class='page-link' href='index.php?include=buku&katakunci=$kata_kunci&halaman=$sebelum'>«</a></li>";
                      }
                      for($i=1; $i<=$jum_halaman; $i++){
                      if ($i > $halaman - 5 and $i < $halaman + 5 ) {
                        if($i!=$halaman){
                            echo "<li class='page-item'><a class='page-link' href='index.php?include=buku&katakunci=$kata_kunci&halaman=$i'>$i</a></li>";
                        }else{
                      ...
                      if($halaman!=$jum_halaman){
                          ...
                          <a class='page-link' href='index.php?include=buku&katakunci=$kata_kunci&halaman=$setelah'>»</a></li>";
                          echo "<li class='page-item'><a class='page-link' href='index.php?include=buku&katakunci=$kata_kunci&halaman=$jum_halaman'>Last</a></li>";
                      }
                  }else{
                    if($halaman!=1){
