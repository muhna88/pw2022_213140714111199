             ...
             <?php }?>
                ...
                <?php 
                      ...
                      if(isset($kata_kunci) && !empty($kata_kunci)){
                        $sql_k .= "WHERE `penerbit` LIKE '%$kata_kunci%' ";
                      }
              ...
              <tr>
                    ...
                    <a href="javascript:if(confirm('Anda yakin ingin menghapus nama penerbit <?= $penerbit; ?>?'))window.location.href ='index.php?include=penerbit&aksi=hapus&data=<?= $id_penerbit;?>&notif=hapusberhasil'" 
              ...
              $sql_jum = "select `id_penerbit`, `penerbit` ,`alamat` from    
                      `penerbit`"; 
              if(isset($_GET["katakunci"])){
                $kata_kunci = $_GET["katakunci"];
                $sql_jum .= "WHERE `penerbit` LIKE '%$kata_kunci%' ";
              }
                ...
                //tidak ada halaman
                  ...
                  if (isset($_GET["katakunci"])){
                      ...
                      if($halaman!=1){
                        ...
                        <a class='page-link' 
                        href='index.php?include=penerbit&katakunci=$kata_kunci&halaman=1'>First</a></li>";
                        echo "<li class='page-item'>
                        <a class='page-link'
                        href='index.php?include=penerbit&katakunci=$kata_kunci&
                      ...
                      if ($i > $halaman - 5 and $i < $halaman + 5 ) {
                        if($i!=$halaman){
                            echo "<li class='page-item'>
                            <a class='page-link' 
                            href='index.php?include=penerbit&katakunci=$kata_kunci&halaman=$i'>
                            $i</a></li>";
                        }else{
                            echo "<li class='page-item'>
                      ...
                      if($halaman!=$jum_halaman){
                          ...
                          echo "<li class='page-item'>
                          <a class='page-link'
                          href='index.php?include=penerbit&katakunci=$kata_kunci&halaman=$jum_halaman'>
                          Last</a></li>";
                      }
                  }else{
                    if($halaman!=1){
