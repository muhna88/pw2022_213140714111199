            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <a href="tambah-kategori-buku" class="btn btn-sm btn-info float-right"><i class="fas fa-plus">
                ...
                <table class="table table-bordered">
                  ...
                  FROM `kategori_buku`  ";
                    ...
                    <tr>
                      ...
                      <a href="javascript:if(confirm('Anda yakin ingin menghapus kategori buku <?php echo $kategori_buku; ?>?'))window.location.href =  
                        ...
                        if($jum_halaman==0){
                          ...
                          if (isset($_GET["katakunci"])){
                              ...
                              if($halaman!=1){
                                  ...
                                  <a class='page-link' 
                                  href=''index.php?include=kategori-buku&$katakunci_kategori&halaman=1'>First</a></li>";
                                  echo "<li class='page-item'>
                                  <a class='page-link' 
                                  href='index.php?include=kategori-buku&$katakunci_kategori&
                              ...
                              for($i=1; $i<=$jum_halaman; $i++){
                                if ($i > $halaman - 5 and $i < $halaman + 5 ) {
                                  if($i!=$halaman){
                                    echo "<li class='page-item'>
                                    <a class='page-link' 
                                    href='index.php?include=kategori-buku&$katakunci_kategori&halaman=$i'>
                                    $i</a></li>";
                                  }else{
                                      echo "<li class='page-item'>
                                ...
                                if($halaman!=$jum_halaman){
                                  ...
                                  echo "<li class='page-item'>
                                  <a class='page-link' 
                                  href='index.php?include=kategori-buku&$katakunci_kategori&halaman=$jum_halaman'>
                                  Last</a></li>";
                                }
                            }else{
                              if($halaman!=1){
